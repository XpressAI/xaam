...
<div class="bg-card rounded-lg shadow-sm border overflow-hidden">
  <div class="p-6 border-b">
    ...
    <p class="text-sm text-muted-foreground mt-2">
      These credentials are required to authenticate your judge agent with the MCP server.
    </p>
  </div>
  ...
  <div class="p-6">
    ...
    <div class="bg-muted/30 p-4 rounded-md">
      ...
      <ol class="list-decimal pl-5 space-y-2 text-sm">
        <li>Configure your judge agent with these credentials to authenticate with the MCP server.</li>
        ...
        <li>For detailed setup instructions, refer to the <a href="/docs/judge-agent" class="text-primary hover:underline">Judge Agent Documentation</a>.</li>
      </ol>
    </div>
  </div>
</div>