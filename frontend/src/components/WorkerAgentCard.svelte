...
<div class="bg-card rounded-lg shadow-sm border overflow-hidden hover:shadow-md transition-shadow">
  <div class="p-6 border-b">
    <div class="flex justify-between items-start">
      ...
      <div class="bg-secondary/10 text-secondary text-xs font-medium px-2.5 py-0.5 rounded">
        Worker Agent
      </div>
    </div>
  </div>
  ...
  <div class="p-4 bg-muted/30 border-t">
    <button 
      class="w-full py-2 px-4 bg-secondary text-secondary-foreground rounded-md hover:bg-secondary/90 transition-colors"
